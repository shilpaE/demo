...
(println edndata) 
  ...
  (try (cond 
         ...
         (empty? jsondata) ((spit "C:\\Users\\se056529\\Documents\\ednvalidator-result.txt" "\n The edn data is \n" :append true)
          ...
          :else (do (spit "C:\\Users\\se056529\\Documents\\ednvalidator-result.txt" "\n Data in edn and json is \n" :append true)
                    (spit "C:\\Users\\se056529\\Documents\\ednvalidator-result.txt" edndata :append true)
                    (spit "C:\\Users\\se056529\\Documents\\ednvalidator-result.txt" jsondata :append true))
          )
...
(-codding "C:\\Users\\se056529\\Documents\\jsontemp.json" "C:\\Users\\se056529\\Downloads\\app-rules-5.0.0\\algorithms\\registry-programs\\cernerstandard.adolescentwellness.clinical.program_ruleset_description.edn")
